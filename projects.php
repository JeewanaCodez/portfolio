            ...
            <div class="project-details">
                ...
                <p>
                 🔹 Key Features: <br>
                    ...
                    💡Environmental violation reporting with location & media <br>

                    💡Tasks, quizzes & missions with point-based rewards <br>

                    💡Eco-friendly marketplace using earned task points <br>

                    💡Community discussions & educational resources <br>

                    💡Event management & donations with email notifications <br>

                    💡Role-based admin & staff management system <br>

                    💡 Eco Guardian turns users into active Eco Guardians, rewarding real-world environmental actions and promoting sustainable living.<br>
